...
def cuckoo_search2(Iterations, nest_number, settings): 
    import random 
    ...
    stepsize = [1,1,0.75,0.75,0.75,1.5] #new addition 7/22 
    pa = 0.2 #the percent of nests(solutions) that are replaced per step 
    nests = [[0 for i in range(6)] for i in range(32)]
    nests[0] = [1,7,9,2000,1.5,12]
    nests[1] = [1,7,9,2000,1.5,30]
    nests[2] = [1,7,9,2000,2.5,12]
    nests[3] = [1,7,9,2000,2.5,30]
    nests[4] = [1,7,9,2000,3,6]
    nests[5] = [1,7,9,2000,3,12]
    nests[6] = [1,7,9,2000,3,30]
    nests[7] = [1,7,9,10000,1.5,6]
    nests[8] = [1,7,9,10000,1.5,12]
    nests[9] = [1,7,9,10000,1.5,30]
    nests[10] = [1,7,9,10000,2.5,6]
    nests[11] = [1,7,9,10000,2.5,12]
    nests[12] = [1,7,9,10000,2.5,30]
    nests[13] = [1,7,9,10000,3,6]
    nests[14] = [1,7,9,10000,3,12]
    nests[15] = [1,7,9,10000,3,30]
    nests[16] = [2,7,9,2000,1.5,6]
    nests[17] = [2,7,9,2000,1.5,12]
    nests[18] = [2,7,9,2000,1.5,30]
    nests[19] = [2,7,9,2000,2.5,30]
    nests[20] = [2,7,9,2000,3,6]
    nests[21] = [2,7,9,2000,3,12]
    nests[22] = [2,7,9,2000,3,30]
    nests[23] = [2,7,9,10000,1.5,6]
    nests[24] = [2,7,9,10000,1.5,12]
    nests[25] = [2,7,9,10000,1.5,30]
    nests[26] = [2,7,9,10000,2.5,6]
    nests[27] = [2,7,9,10000,2.5,12]
    nests[28] = [2,7,9,10000,2.5,30]
    nests[29] = [2,7,9,10000,1.5,6]
    ...
    return best_nest_print, max(fitness) 
